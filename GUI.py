...
output_data_message = {'greetings': """\033[36mПриветствую Вас! 
        ...
        Для того чтобы определить важность заметки введите \033[32m"important"\033[36m если это важная заметка или \033[32m"not important"\033[36m если обычная заметка
        ...
        """,
               ...
               'err_sort': '\033[36mВ процессе сортировки возникла ошибка\033[0m',
               'err_csv': '\033[36mВ процессе создания csv файла возникла ошибка\033[0m',
...
def print_search_note(note: list) -> None or bool:
    """
...
def print_sorted_notes(matrix_note: list[list], input_data: str):
    """
